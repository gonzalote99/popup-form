...
(function($){
	$.fn.lightWeightPopup = function(options) {
		...
		$(this).on("click",function(){
			...
			$("body").append('<div class="lwp-overlay" '+setOL+'></div><div class="lwp" tabindex="-1" role="dialog"><div id="lwp" style="'+sw+' '+sh+' '+smw+' '+smh+'"><div id="lwpHead"><div class="title">'+settings.title+'</div><div class="close" onclick="closeDilog(\''+dset.content+'\')"><span>&times;</span></div></div><div id="lwpBody" role="document" '+setMF+'><div class="loading"><img src="https://raw.githubusercontent.com/LearnCodeWeb/how-to-create-a-custom-popup-form-with-php-ajax/master/image/loader.gif"><p class="text">Please Wait..!</p></div></div></div></div>');
